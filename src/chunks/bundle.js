...
System.register("chunks:///_virtual/state-machine.min.mjs_cjs=&original=.js", ['./cjs-loader.mjs', './state-machine.min.js'], function (exports, module) {
  'use strict';
...
System.register("chunks:///_virtual/util.mjs_cjs=&original=.js", ['./cjs-loader.mjs', './util.js'], function (exports, module) {
  'use strict';
  ...
  return {
    ...
    execute: function () {
      // I am the facade module who provides access to the CommonJS module './util.js'~
      if (!__cjsMetaURL) {
        loader.throwInvalidWrapper('./util.js', module.meta.url);
      }
...
System.register("chunks:///_virtual/events.mjs_cjs=&original=.js", ['./cjs-loader.mjs', './events.js'], function (exports, module) {
  'use strict';
...
System.register("chunks:///_virtual/socket.io.mjs_cjs=&original=.js", ['./cjs-loader.mjs', './socket.io.js'], function (exports, module) {
  'use strict';
  ...
  return {
    ...
    execute: function () {
      // I am the facade module who provides access to the CommonJS module './socket.io.js'~
      if (!__cjsMetaURL) {
        loader.throwInvalidWrapper('./socket.io.js', module.meta.url);
      }
...
System.register("chunks:///_virtual/socket.io.js", ['./cjs-loader.mjs'], function (exports, module) {
  'use strict';
    ...
    execute: function () {
      ...
      loader.define(module.meta.url, function (exports$1, _require, module, __filename, __dirname) {
        ...
        (function () {
           ...
           */
          !function (t, e) {
            "object" == typeof exports$1 && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports$1 ? exports$1.io = e() : t.io = e();
          }(this, function () {
            return function (t) {
              function e(r) {
              ...
              !function (t) {
                e.encode = function (e) {
                  ...
                  for (n = 0; n < c; n += 4) {
                    r = t.indexOf(e[n]), o = t.indexOf(e[n + 1]), i = t.indexOf(e[n + 2]), s = t.indexOf(e[n + 3]), h[p++] = r << 2 | o >> 4, h[p++] = (15 & o) << 4 | i >> 2, h[p++] = (3 & i) << 6 | 63 & s;
                  }
